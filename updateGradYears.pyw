...
if __name__ == '__main__':  # main file execution
    with open('grad_year_log.txt', 'w') as log:
        ...
        try:
            ...
            print(f'ERROR while doing overall execution not caught by other try block: {er}')
            print(f'ERROR while doing overall execution not caught by other try block: {er}', file=log)
